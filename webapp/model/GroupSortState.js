sap.ui.define([
  ...
  return BaseObject.extend("ui5experts.ui-testing.model.GroupSortState", {
     ...
     * @alias ui5experts.ui-testing.model.GroupSortState
     */
    ...
    /**
     * Sorts by TripActivityName, or by EstimatedCost/Value
     *
    ...
    /**
     * Groups by EstimatedCost/Value, or resets the grouping for the key "None"
     *
     * @param {string} sKey - the key of the field used for grouping
     * @returns {sap.ui.model.Sorter[]} an array of sorters
     */
    group: function (sKey) {
      ...
      if (sKey === "EstimatedCost/Value") {
        // Grouping means sorting so we set the select to the same Entity used for grouping
        this._oViewModel.setProperty("/sortBy", "EstimatedCost/Value");

        aSorters.push(
          new Sorter("EstimatedCost/Value", false,
            this._fnGroupFunction.bind(this))
        );
      } else if (sKey === "None") {
        // select the default sorting again
        this._oViewModel.setProperty("/sortBy", "TripActivityName");
      }
