...
sap.ui.define([
    ...
    "ui5experts/ui-testing/model/grouper",
    ...
    return BaseController.extend("ui5experts.ui-testing.controller.Master", {
      ...
      onSearch: function (oEvent) {
        ...
        if (sQuery) {
          this._oListFilterState.aSearch = [new Filter("TripActivityName", FilterOperator.Contains, sQuery)];
        } else {
      ...
      onOpenViewSettings: function () {
        if (!this._oViewSettingsDialog) {
          this._oViewSettingsDialog = sap.ui.xmlfragment("ui5experts.ui-testing.view.ViewSettingsDialog", this);
      ...
      onConfirmViewSettingsDialog: function (oEvent) {
        ...
        aFilterItems.forEach(function (oItem) {
          switch (oItem.getKey()) {
            case "Filter1" :
              aFilters.push(new Filter("EstimatedCost/Value", FilterOperator.LE, 1000));
              break;
            case "Filter2" :
              aFilters.push(new Filter("EstimatedCost/Value", FilterOperator.GT, 1000));
              break;
            default :
              break;
          }
      ...
      _onMasterMatched: function () {
        this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
          function (mParams) {
            ...
            var sObjectId = mParams.firstListitem.getBindingContext().getProperty("WorkItemID");
