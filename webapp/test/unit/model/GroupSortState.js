sap.ui.define([
  ...
  QUnit.test("Should always return a sorter when sorting", function (assert) {
    // Act + Assert
    assert.strictEqual(this.oGroupSortState.sort("EstimatedCost/Value").length, 1, "The sorting by Estimated Cost returned a sorter");
  ...
  QUnit.test("Should return a grouper when grouping", function (assert) {
    // Act + Assert
    assert.strictEqual(this.oGroupSortState.group("EstimatedCost/Value").length, 1, "The group" +
      " by Estimated Cost returned a sorter");
