sap.ui.define([
    ...
    opaTest("Should see a busy indication on the master and detail after loading the metadata", function (Given, When, Then) {
      ...
      // Assertions
      Then.onTheMasterPage.iShouldSeeTheBusyIndicator().and.theListHeaderDisplaysZeroHits();
      Then.onTheDetailPage.iShouldSeeTheBusyIndicator().and.iTeardownMyAppFrame();
    });
