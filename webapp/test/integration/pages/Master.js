    ...
    Opa5.createPageObjects({
      onTheMasterPage: {
        ...
        actions: {
              ...
              success: function (aEntityData) {
                this.waitFor({
                  ...
                  success: function (oList) {
                    ...
                    oCurrentItem.bindingPath = "/" + oList.getModel().createKey("Travels", {
          ...
          iRememberTheListItem: function (oListItem) {
            ...
            this.getContext().currentItem = {
              ...
              title: oBindingContext.getProperty("TripActivityName")
            };
          }
        },
        ...
        assertions: {
          ...
          theListGroupShouldBeFilteredOnUnitNumberValue1000OrLess: function () {
            return this.theListShouldBeFilteredOnUnitNumberValue(1000, false, {
              iLow: 1,
              iHigh: 2
            });
          },
          ...
          theListHeaderDisplaysZeroHits: function () {
            return this.waitFor({
              viewName: sViewName,
              id: "page",
              matchers: new PropertyStrictEquals({name: "title", value: "Travels (0)"}),
              success: function () {
          ...
          theListShouldBeSortedAscendingOnUnitNumber: function () {
            return this.theListShouldBeSortedAscendingOnField("EstimatedCost/Value");
          },

          theListShouldBeSortedAscendingOnName: function () {
            return this.theListShouldBeSortedAscendingOnField("TripActivityName");
          },
          ...
          theListShouldHaveAllEntries: function () {
            ...
            // retrieve all Travels to be able to check for the total amount
