sap.ui.define([
    ...
    opaTest("MasterList Filtering on Estimated Cost less than 1000", function (Given, When, Then) {

      // Action
      When.onTheMasterPage.iOpenViewSettingsDialog().and.iSelectListItemInViewSettingsDialog("Estimated Cost").and.iSelectListItemInViewSettingsDialog("< 1000").and.iPressOKInViewSelectionDialog();

      // Assertion
      Then.onTheMasterPage.theMasterListShouldBeFilteredOnUnitNumberValueLessThanTheGroupBoundary();
    });

    opaTest("MasterList Filtering on Estimated Cost more than 1000", function (Given, When, Then) {
      // Action
      When.onTheMasterPage.iOpenViewSettingsDialog().and.iSelectListItemInViewSettingsDialog("> 1000").and.iPressOKInViewSelectionDialog();
